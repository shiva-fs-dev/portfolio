export default function AboutPage() {
  return (
    <div className="p-2 md:p-8">
      ...
      <section className="bg-gray-50 dark:bg-gray-950 text-gray-900 dark:text-white px-6 py-5 transition-colors duration-300">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="text-lg md:text-xl text-gray-700 dark:text-gray-300 leading-relaxed mb-6">
            <div className="max-w-4xl mx-auto p-6 bg-gray-100 dark:bg-gray-800 shadow-lg border border-gray-200 rounded-xl md:text-justify">
              <p className="md:text-2xl font-bold text-gray-800 dark:text-white">
                ...
                and <span className="text-indigo-500">React</span> to create
              ...
              <div className="mt-10 text-left md:text-justify">
                <h2 className="text-2xl font-bold mb-4 text-gray-800 dark:text-white">
                  💼 How I Can Help Your Team
                </h2>
                <ul className="list-disc pl-5 space-y-3 text-gray-700 dark:text-gray-300 text-lg">
                  <li>
                    🧩Maintain legacy ColdFusion codebases and modernize without
                breaking flow
                  </li>
                  <li>
                  ...
                  <li>
                    ⚙️Enhancing application performance
                  </li>
                  <li>
                    🎨Redesign UI using React + Tailwind for better UX
                  </li>
                  {/* <li>
