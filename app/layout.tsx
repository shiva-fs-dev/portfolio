...
export default function RootLayout({
  ...
  return (
    <html lang="en">
      <ThemeToggle>
        <Header>
          <div className="flex flex-row h-screen font-sans transition-colors duration-300 bg-zinc-50 text-zinc-900 dark:bg-zinc-900 dark:text-white">
            <Sidebar />
            <main className="flex-1 md:p-6 overflow-y-auto transition-colors duration-300">
              {children}
            </main>
          </div>
        </Header>
